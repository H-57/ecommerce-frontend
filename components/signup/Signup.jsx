        ...
        <div className="bg-slate-900 flex min-h-full flex-1 flex-col justify-center px-6 py-12 lg:px-8">
          ...
          <div className=" marker:mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
            <form className="space-y-6" >
              <div>
                <label  htmlFor="name" className="text-white block text-sm font-medium leading-6 text-gray-900">
                  Name
                </label>
                <div className="mt-2">
                  <input
              ...
              <div>
                <label  htmlFor="Mobileno" className="text-white block text-sm font-medium leading-6 text-gray-900">
                  Mobile No:
                </label>
                <div className="mt-2">
                  <input
